...
<div class="content_container">
	...
	<hr>
	<p>
		<a href="<?php echo base_url.'admin/add-category-post'; ?>" class="btn btn-md btn-primary">Thêm mới</a>		
	</p>
	<table id="table_category" class="table table-bordered">
		...
		<tbody>
			...
			<tr>
				...
				<td><a href="<?php echo base_url.'admin/edit-cat-post/'.$cat->id; ?>" class="btn btn-warning btn-md"><i class="fa fa-edit"></i> Sửa</a></td>
				<td><a href="<?php echo base_url.'admin/delete-cat-post/'.$cat->id; ?>" class="btn btn-md btn-danger" onclick="
